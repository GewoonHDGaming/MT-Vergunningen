...
public class Licentie {
	...
	public Licentie(String licenseKey, String validationServer, Plugin plugin){
		this.licenseKey = licenseKey;
		this.plugin = plugin;
		this.validationServer = validationServer;
	}
	
	public Licentie setSecurityKey(String securityKey){
		this.securityKey = securityKey;
		return this;
	}
	
	public Licentie setConsoleLog(LogType logType){
		this.logType = logType;
		return this;
	}
	
	public Licentie debug(){
		debug = true;
		return this;
	}
